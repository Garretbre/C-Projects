    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            else
            {
                ...
                if (currentWidth + currentHeight + currentLength > 50)
                {
                    Console.WriteLine("Package too big to be shipped via Package Express.");
                }
                else
                {
                    Console.WriteLine($"Your estimated total for shipping this package is:    ${Convert.ToDecimal(currentWidth * currentHeight * currentLength)*currentWeight / 100}");
